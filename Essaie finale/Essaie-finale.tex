...
\title{L'importance de la transparence et reproductibilité}

\author[a,1,2]{Jordan Lenneville}
...
\significancestatement{Utile ???Authors must submit a 120-word maximum
statement about the significance of their research paper written at a
level understandable to an undergraduate educated scientist outside
their field of speciality. The primary goal of the Significance
Statement is to explain the relevance of the work in broad context to a
broad readership. The Significance Statement appears in the paper itself
...
% Keywords are not mandatory, but authors are strongly encouraged to provide them. If provided, please include two to five keywords, separated by the pipe symbol, e.g:
 \keywords{  Reproductibilité |  Transparence |  Beubé |  Je
t'aime |  Tout plein  } 
...
Introduction This PNAS journal template is provided to help you write
...
\hypertarget{argument-x}{%
\section*{Argument x}\label{argument-x}}
\addcontentsline{toc}{section}{Argument x}

Allo

\hypertarget{argument-y}{%
\section*{Argument y}\label{argument-y}}
\addcontentsline{toc}{section}{Argument y}

Alloha

\hypertarget{argument-z}{%
\section*{Argument z}\label{argument-z}}
\addcontentsline{toc}{section}{Argument z}
...
this will be done automatically via bibtex, e.g. (1) and
(\textbf{berard1994embedding?}, \textbf{coifman2005geometric?}). All
...
\begin{figure}
\centering
\includegraphics{grenouille.jpg}
\caption{Une belle gornouille qui danse .{}}
\end{figure}

\begin{figure}
\centering
\includegraphics{Istadbut.jpg}
